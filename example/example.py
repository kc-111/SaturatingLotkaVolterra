...
n_samples = 96
t_span = (0.0, 24.0)
t_eval = torch.linspace(0.0, 24.0, 100)

species_names = [f"Species_{i+1}" for i in range(n_species)]

# Single shared model (same dynamics across all samples)
...
# --- Plot time series per treatment ---
...
fig.suptitle("Species Dynamics per Treatment", fontsize=14)
fig.tight_layout()
